...
import { SEARCH_INDEX } from '@/utils/mockOperations';
...
export default function OperationsSearchBar({ onSelect, searchIndex }) {
  ...
  return (
    <>
      ...
      >
        <span>🔍</span>
        <span className="flex-1 text-left">Search tickets, incidents, admins…</span>
      </button>
              ...
              >
                <div className="flex items-center gap-2 px-4 py-3 border-b border-border-subtle">
                  ...
                  <input
                    ...
                    placeholder="Search tickets, incidents, users, campaigns, reports, admins, activities…"
