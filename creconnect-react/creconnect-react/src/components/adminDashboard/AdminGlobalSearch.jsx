  ...
  return (
    <>
      <button
        ...
        className="flex items-center gap-2 px-3.5 py-2 rounded-xl bg-surface-2 hover:bg-surface text-fg-muted text-sm transition-colors w-full sm:w-64"
      >
        <span>🔍</span>
        <span className="flex-1 text-left">Search users, brands, campaigns…</span>
      </button>
